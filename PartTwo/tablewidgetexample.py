...
class Window(QWidget):
    def __init__(self):
        ...
        table_widget.setItem(1, 0, QTableWidgetItem("Jamie"))
        table_widget.setItem(1, 1, QTableWidgetItem("jamie@gmail.com"))
        table_widget.setItem(1, 2, QTableWidgetItem("4156013555"))

        table_widget.setItem(2, 0, QTableWidgetItem("John"))
        table_widget.setItem(2, 1, QTableWidgetItem("john@gmail.com"))
        table_widget.setItem(2, 2, QTableWidgetItem("4154458764"))
