# Form implementation generated from reading ui file 'listwidgetadd.ui'
#
...
class Ui_Dialog(QDialog):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(483, 368)
        self.widget = QtWidgets.QWidget(Dialog)
        self.widget.setGeometry(QtCore.QRect(0, 70, 361, 271))
    ...
    def remove_item(self):
        ...
        if item is None:
            return
        reply = QMessageBox.question(self, "Remove Item", "Do you want to remove the item? ", QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No)
