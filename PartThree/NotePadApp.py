...
# triggers for when the toolbar buttons are used
# actionSave, actionNew etc. are the names I used in the NotePadDemo.py file (and designer)
...
# these five are built in functions, so we trigger them without creating an accompanying function
        ...
        self.actionDown.triggered.connect(self.align_center)
...
# if the document has been changed and user tries to create a new document, this asks them if they
# should save or discard the changes.
    def maybe_save(self):
